...
class StaticShader extends FlxShader {
    public var staticStrength(default, set):Float = 0;
            @:glFragmentSource('
    ...
    public function new(strength:Float = 1, ?file:String = '')
    {
        super();
        staticStrength = strength;
    }

    function set_staticStrength(val:Float):Float {
        staticStrength = val;
        data.staticStrength.value[0] = [staticStrength];
        return staticStrength;
    }
