 ...
 */
class FlxSquareButton extends FlxTypedButton<FlxText> {
	/**
	...
	inline function initLabel(Text:String):Void {
		if (Text != null) {
			label = new FlxText(x + labelOffsets[FlxButtonState.NORMAL].x, y + labelOffsets[FlxButtonState.NORMAL].y, 20, Text);
