...
enum abstract FlxButtonState2(Int) to Int {
 ...
 */
class FlxSquareButton2 extends FlxTypedButton2<FlxText> {
	/**
	 * Used with public variable status, means not highlighted or pressed.
	 */
	@:dox(hide) @:noCompletion
	@:deprecated("FlxButton.NORMAL is deprecated, use FlxButtonState2.NORMAL")
	public static inline var NORMAL = FlxButtonState2.NORMAL;

	/**
	 * Used with public variable status, means highlighted (usually from mouse over).
	 */
	@:dox(hide) @:noCompletion
	@:deprecated("FlxButton.HIGHLIGHT is deprecated, use FlxButtonState2.HIGHLIGHT")
	public static inline var HIGHLIGHT = FlxButtonState2.HIGHLIGHT;

	/**
	 * Used with public variable status, means pressed (usually from mouse click).
	 */
	@:dox(hide) @:noCompletion
	@:deprecated("FlxButton.PRESSED is deprecated, use FlxButtonState2.PRESSED")
	public static inline var PRESSED = FlxButtonState2.PRESSED;

	/**
	 * Used with public variable status, means non interactible.
	 */
	@:dox(hide) @:noCompletion
	@:deprecated("FlxButton.DISABLED is deprecated, use FlxButtonState2.DISABLED")
	public static inline var DISABLED = FlxButtonState2.DISABLED;
	...
	inline function initLabel(Text:String):Void {
		if (Text != null) {
			label = new FlxText(x + labelOffsets[FlxButtonState2.NORMAL].x, y + labelOffsets[FlxButtonState2.NORMAL].y, 30, Text);
			label.setFormat(null, 16, 0x333333, "center");
...
@:generic
#end
class FlxTypedButton2<T:FlxSprite> extends FlxSprite implements IFlxInput {
	/**
	 ...
	 */
	public var status(default, set):FlxButtonState2;
	...
	function loadDefaultGraphic():Void {
		loadGraphic("assets/ui/buttonSQR2.png", true, 30, 30);
	}
	...
	function set_status(value:FlxButtonState2):FlxButtonState2 {
		status = value;
		updateLabelAlpha();
		updateLabelPosition();
		return status;
